...
usuario1.make_deposit(300).make_deposit(500).make_deposit(300).make_withdrawal(100)
print(usuario1.display_user_balance())

#Haz que el segundo usuario haga 2 depósitos y 2 retiros y luego muestre su saldo
usuario2.make_deposit(2000).make_deposit(100).make_withdrawal(200).make_withdrawal(500)
print(usuario2.display_user_balance())

#Haz que el tercer usuario haga 1 depósitos y 3 retiros y luego muestre su saldo
usuario3.make_deposit(3000).make_withdrawal(500).make_withdrawal(200).make_withdrawal(1000)
